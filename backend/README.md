...
## Project Structure
    ...
    ├── testautomateapp_dev_23164  # Django project configurations
...
1. Clone this repo and `cd testautomateapp_dev_23164`
...
2. Clone this repo and `cd testautomateapp_dev_23164`
